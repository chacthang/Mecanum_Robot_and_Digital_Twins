...
#ifndef RTW_HEADER_digitaltwins_2_h_
#define RTW_HEADER_digitaltwins_2_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef digitaltwins_2_COMMON_INCLUDES_
#define digitaltwins_2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "rtw_continuous.h"
#include "rtw_solver.h"
#endif                                 /* digitaltwins_2_COMMON_INCLUDES_ */

#include "digitaltwins_2_types.h"
#include "rtGetInf.h"
...
typedef struct {
  ...
  real_T Tp[4];                        /* '<Root>/Tp' */
  real_T Tv[4];                        /* '<Root>/Tv' */
} ExtY_digitaltwins_2_T;

/* Real-time Model Data Structure */
struct tag_RTM_digitaltwins_2_T {
  const char_T *errorStatus;
  RTWSolverInfo solverInfo;
  X_digitaltwins_2_T *contStates;
...
/* Block signals (default storage) */
extern B_digitaltwins_2_T digitaltwins_2_B;

/* Continuous states (default storage) */
extern X_digitaltwins_2_T digitaltwins_2_X;

/* Block states (default storage) */
extern DW_digitaltwins_2_T digitaltwins_2_DW;

/* External inputs (root inport signals with default storage) */
extern __declspec(dllexport) ExtU_digitaltwins_2_T digitaltwins_2_U;

__declspec(dllexport) ExtU_digitaltwins_2_T* get_rtU() {
    return &digitaltwins_2_U;
}

/* External outputs (root outports fed by signals with default storage) */
extern __declspec(dllexport) ExtY_digitaltwins_2_T digitaltwins_2_Y;

__declspec(dllexport) ExtY_digitaltwins_2_T* get_rtY() {
    return &digitaltwins_2_Y;
}

/* Model entry point functions */
extern __declspec(dllexport) void digitaltwins_2_initialize(void);
extern __declspec(dllexport) void digitaltwins_2_step(void);
extern void digitaltwins_2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_digitaltwins_2_T *const digitaltwins_2_M;
 ...
 *
 * '<Root>' : 'digitaltwins_2'
 * '<S1>'   : 'digitaltwins_2/CONTROL'
 * '<S2>'   : 'digitaltwins_2/Physical Plant'
 * '<S3>'   : 'digitaltwins_2/Virtual Plant'
 * '<S4>'   : 'digitaltwins_2/CONTROL/MATLAB Function'
 * '<S5>'   : 'digitaltwins_2/CONTROL/x2r'
 * '<S6>'   : 'digitaltwins_2/Physical Plant/MATLAB Function1'
 * '<S7>'   : 'digitaltwins_2/Virtual Plant/CONTROL 2'
 * '<S8>'   : 'digitaltwins_2/Virtual Plant/Qv_'
 * '<S9>'   : 'digitaltwins_2/Virtual Plant/Virtual Plant'
 * '<S10>'  : 'digitaltwins_2/Virtual Plant/CONTROL 2/MATLAB Function'
 * '<S11>'  : 'digitaltwins_2/Virtual Plant/CONTROL 2/x2r'
 * '<S12>'  : 'digitaltwins_2/Virtual Plant/Virtual Plant/Virtual robot'
 */
#endif                                 /* RTW_HEADER_digitaltwins_2_h_ */
