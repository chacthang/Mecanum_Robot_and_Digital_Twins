###########################################################################
## Makefile generated for component 'dynamic_8'. 
## 
## Makefile     : dynamic_8.mk
## Generated on : Mon Apr 08 01:12:56 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dynamic_8
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dynamic_8
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/dynamic_8_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=dynamic_8 -DNUMST=2 -DNCSTATES=6 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/dynamic_8_ert_rtw/dynamic_8.c

MAIN_SRC = $(START_DIR)/dynamic_8_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/dynamic_8_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/dynamic_8_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
dynamic_8.o : $(START_DIR)/dynamic_8_ert_rtw/dynamic_8.c
	$(CC) $(CFLAGS) -o $@ $<


ert_main.o : $(START_DIR)/dynamic_8_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o $@ $<
