/*
 * File: dynamic_circle.c
 *
 * Code generated for Simulink model 'dynamic_circle'.
 *
 * Model version                  : 7.32
 * Simulink Coder version         : 9.4 (R2020b) 29-Jul-2020
 * C/C++ source code generated on : Sat Apr  6 18:34:48 2024
 *
...
void dynamic_circle_step(void)
{
...

  {
     ...
     *  Sin: '<Root>/Sine Wave'
     */
    w1 = 0.41887902047863906 * rtM->Timing.t[0];

    /* Sin: '<Root>/Sine Wave1' */
    rtDW.SineWave1 = -sin(w1 + 1.5707963267948966);

    /* Sin: '<Root>/Sine Wave' */
    rtDW.SineWave = sin(w1);
