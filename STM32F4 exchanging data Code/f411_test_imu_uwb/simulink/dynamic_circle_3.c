/*
 * File: dynamic_circle_3.c
 *
 * Code generated for Simulink model 'dynamic_circle_3'.
 *
 * Model version                  : 7.39
 * Simulink Coder version         : 9.4 (R2020b) 29-Jul-2020
 * C/C++ source code generated on : Sun May  5 17:09:56 2024
 *
...
extern void dynamic_circle_3_derivatives(void);
...
/* Model step function */
void dynamic_circle_3_step(void)
{
...

  {
     ...
     *  Sin: '<Root>/Sine Wave'
     */
    w2 = 0.41887902047863906 * rtM->Timing.t[0];

    /* Sum: '<Root>/Sum' incorporates:
     *  Constant: '<Root>/Constant1'
     *  Sin: '<Root>/Sine Wave1'
     */
    rtDW.Sum = sin(w2 + 1.5707963267948966) * -0.7 + 1.0;

    /* Sum: '<Root>/Sum1' incorporates:
     *  Constant: '<Root>/Constant2'
     *  Sin: '<Root>/Sine Wave'
     */
    rtDW.Sum1 = sin(w2) * 0.7 + 1.0;
    ...
    if ((rtDW.TimeStampA >= w1) && (rtDW.TimeStampB >= w1)) {
       ...
       */
      rtDW.Derivative1[0] = (rtDW.Sum - (*lastU)[0]) / w2;
      rtDW.Derivative1[1] = (rtDW.Sum1 - (*lastU)[1]) / w2;
     ...
     *  Inport: '<Root>/Q'
     */
    rtDW.Sum_n[0] = rtDW.Sum - rtU.Q[0];
    rtDW.Sum_n[1] = rtDW.Sum1 - rtU.Q[1];
    rtDW.Sum_n[2] = 0.0 - rtU.Q[2];
    ...
    if ((rtDW.TimeStampA_o >= w1) && (rtDW.TimeStampB_g >= w1)) {
      ...
      w2 = w1 - w2;
      rtb_Derivative_idx_0 = (rtDW.Sum_n[0] - (*lastU)[0]) / w2;
      rtb_Derivative_idx_1 = (rtDW.Sum_n[1] - (*lastU)[1]) / w2;
      rtb_Derivative_idx_2 = (rtDW.Sum_n[2] - (*lastU)[2]) / w2;
    }
    ...
    B_0[4] = xm;
    B_0[7] = (-cos(rtU.Q[2]) + ym) * 20.833333333333332;
    B_0[10] = xm;
    B_0[2] = -12.499999999999998;
    B_0[5] = 12.499999999999998;
    B_0[8] = 12.499999999999998;
    B_0[11] = -12.499999999999998;
    xm = w3 * rtU.Q_dot[0] + ym * rtU.Q_dot[1];
    ym = -ym * rtU.Q_dot[0] + w3 * rtU.Q_dot[1];
    w3 = xm - ym;
    w1 = (w3 - 0.6 * rtU.Q_dot[2]) * 20.833333333333332;
    ym += xm;
    w2 = (ym + 0.6 * rtU.Q_dot[2]) * 20.833333333333332;
    w3 = (w3 + 0.6 * rtU.Q_dot[2]) * 20.833333333333332;
    xm = (ym - 0.6 * rtU.Q_dot[2]) * 20.833333333333332;
    ...
    ym = 178.61111111111111 * rtU.Q_dot[1] * rtU.Q_dot[2];
    absx21 = -178.61111111111111 * rtU.Q_dot[0] * rtU.Q_dot[2];
    if (w1 < 0.0) {
      w1 = -1.0;
    } else if (w1 > 0.0) {
      w1 = 1.0;
    ...
    for (p1 = 0; p1 < 3; p1++) {
      ...
      tmp[p1] = ((((real_T)a[p1 + 3] * rtDW.Sum_n[1] + (real_T)a[p1] *
                   rtDW.Sum_n[0]) + (real_T)a[p1 + 6] * rtDW.Sum_n[2]) +
                 rtDW.Derivative1[p1]) - rtU.Q_dot[p1];
    ...
    w2 = rtb_Derivative2_0[0] + rtb_Derivative2[0];
    xm = rtb_Derivative2_0[1] + rtb_Derivative2[1];
    w1 = rtb_Derivative2_0[2] + rtb_Derivative2[2];
    for (p1 = 0; p1 < 4; p1++) {
      w3 = y_tmp[p1 + 8] * w1 + (y_tmp[p1 + 4] * xm + y_tmp[p1] * w2);
    ...
    xm = (cos(rtX.Integrator1_CSTATE[2]) + sin(rtX.Integrator1_CSTATE[2])) *
      20.833333333333332;
    B_0[6] = xm;
  ...
  if (rtmIsMajorTimeStep(rtM)) {
    ...
    (*lastU)[0] = rtDW.Sum_n[0];
    (*lastU)[1] = rtDW.Sum_n[1];
    (*lastU)[2] = rtDW.Sum_n[2];
...
void dynamic_circle_3_derivatives(void)
{
  XDot *_rtXdot;
...
void dynamic_circle_3_initialize(void)
{
  /* Registration code */
  ...
  rtX.Integrator1_CSTATE[0] = 1.0;

  /* InitializeConditions for Integrator: '<S2>/Integrator' */
  rtX.Integrator_CSTATE[1] = 0.0;

  /* InitializeConditions for Integrator: '<S2>/Integrator1' */
  rtX.Integrator1_CSTATE[1] = 1.0;
